...
if (mes == (1 or 3 or 5 or 7 or 8 or 10 or 12) and (dia >0 and dia <=31)):
    ...
    print ("VALIDO")
elif (mes == 2 and (dia >0 and dia <29)): #cambio de digito limite de 31 a 29
    print ("VALIDO")
elif ((ano%4 == 0) and (mes == 2) and (dia >0 and dia <30)): #cambio de digito limite de 28 a 30 para que entre el 29 
    print ("VALIDO")
